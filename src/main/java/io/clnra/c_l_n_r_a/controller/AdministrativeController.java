...
public class AdministrativeController {
    ...
    public void prepareContext(final Model model) {
        model.addAttribute("cBORegistrationValues", cBORegistrationRepository.findAll().stream().collect(
                Collectors.toMap(CBORegistration::getId, CBORegistration::getCBOName)));
    }
